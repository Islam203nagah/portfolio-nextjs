...
export function ExperienceTab({ profile, onProfileChange }: ExperienceTabProps) {
  const setExperience = (experience: ExperienceItem[]) =>
    onProfileChange({ ...profile, experience });
        ...
        {(profile.experience || []).map((item, index) => (
          ...
          >
            <div className={cn('mb-3', 'flex', 'items-center', 'justify-between')}>
              ...
              <button
                onClick={() => setExperience(profile.experience.filter((_, i) => i !== index))}
